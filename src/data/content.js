...
export const PROJECTS = [
  {
    ...
    index: "01",
    name: "Jigsaw",
    tag: "Interactive puzzle web app",
    period: "2025 →",
    status: "In progress — backend layer underway",
    desc: "A browser-based jigsaw puzzle that actually validates where a piece belongs instead of trusting the honor system — smooth drag-and-drop feedback, semantic HTML, and CSS disciplined enough to behave on any screen size.",
    stack: ["HTML5", "CSS3", "JavaScript", "Node.js", "MySQL"],
    note: "next up: Node.js + MySQL, so progress survives a refresh",
    media: [],
    liveUrl: null,
    githubUrl: "https://github.com/built-with-aman",
    demoVideo: null,
    highlights: [
      "A responsive, browser-based puzzle built from components that get reused, not copy-pasted.",
      "JavaScript-driven state management handles piece interaction, placement validation and feedback — in real time, no lag between drop and verdict.",
      "Semantic HTML and modular CSS keep the puzzle behaving itself across screen sizes.",
      "Next: Node.js and MySQL for persistence, backend workflows and an architecture built to outgrow the demo stage.",
    ],
  },
  {
    id: "sheetcraft",
